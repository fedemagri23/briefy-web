...
export default function NewsCard({ item }: NewsCardProps) {
  ...
  return (
    <div className="mb-8 pb-8 border-b border-neutral-100 dark:border-neutral-900 last:border-0">
      <div className={`flex flex-col ${item.videoId ? "md:flex-row" : ""} gap-4 items-start`}>
        {/* Tarjeta principal */}
        <article className="w-full md:flex-1 bg-neutral-50 dark:bg-neutral-950 rounded-2xl p-5">
